...
const routes: Routes = [
  ...
  {
    path: 'home',
    loadChildren: () => import('./ingestar/home/home.module').then( m => m.HomePageModule)
  },

  {
    path: 'list/:serviceId/:serviceName',
    loadChildren: () => import('./ingestar/list/list.module').then( m => m.ListPageModule)
  },

  {
    path: 'detail/:serviceId/:serviceName',
    loadChildren: () => import('./ingestar/list/list.module').then( m => m.ListPageModule)
  },
  ...
  {
    path: 'detail',
    loadChildren: () => import('./ingestar/detail/detail.module').then( m => m.DetailPageModule)
  }
